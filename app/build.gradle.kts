...
// Falls back gracefully so debug builds keep working without a keystore.
...
android {
    ...
    buildTypes {
        release {
            ...
            // debug signing config so the project still builds out-of-the-box.
